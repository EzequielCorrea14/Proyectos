...
import styles from '../Pages/Home/Components/Slider.module.css';
import { FaCircleArrowLeft , FaCircleArrowRight} from "react-icons/fa6";

function ImageSliderProduct({ images }) {
			...
			{images.map((image, index) => {
				return (
					<div
						...
						{currentImage === index && (
							<img style={{ width: '94%', height:'auto', marginLeft: '20px',marginTop:'34px'  }} key={index} src={image} alt="image" />
						)}
					</div>
				);
			})}
